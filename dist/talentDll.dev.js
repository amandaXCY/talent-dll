...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jquery"] = __webpack_require__("./node_modules/expose-loader/index.js?$!./node_modules/expose-loader/index.js?_!./node_modules/@beisen/jquery/index.js");
...
/***/ "./node_modules/@beisen/lodash/index-es6.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/@beisen/marionette/index-es6.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__ = __webpack_require__("./node_modules/@beisen/lodash/index-es6.js");
...
__WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].ChildViewContainer = (function() {
  ...
  var Container = function(views) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(views, this.add, this);
  };

  // Container Methods
  // -----------------

  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(Container.prototype, {
    ...
    findByIndex: function(index) {
      return __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].values(this._views)[index];
    },
    ...
    remove: function(view) {
      ...
      // delete custom index
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].any(this._indexByCustom, function(cid, key) {
        if (cid === viewCid) {
    ...
    call: function(method) {
      this.apply(method, __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].tail(arguments));
    },
    ...
    apply: function(method, args) {
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(this._views, function(view) {
        if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(view[method])) {
    ...
    _updateLength: function() {
      this.length = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].size(this._views);
    }
  });
  ...
  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(methods, function(method) {
    Container.prototype[method] = function() {
      var views = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].values(this._views);
      var args = [views].concat(__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].toArray(arguments));
      return __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"][method].apply(__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"], args);
    };
  });
...
__WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Wreqr = (function() {
  "use strict";
  var Wreqr = {};
  ...
  Wreqr.Handlers = (function(Backbone, _) {
    ...
    return Handlers;
  })(__WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"], __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"]);
  ...
  Wreqr.CommandStorage = (function() {
    ...
    var CommandStorage = function(options) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(this.initialize)) {
        this.initialize(options);
      }
    };

    // Instance methods
    __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(CommandStorage.prototype, __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Events, {
  ...
  Wreqr.Commands = (function(Wreqr) {
    ...
    return Wreqr.Handlers.extend({
      ...
      _executeCommands: function(name, handler, context) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(command.instances, function(args) {
      ...
      _initializeStorage: function(options) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(StorageType)) {
...
var Marionette = (function() {
  "use strict";

  // Define and export the Marionette namespace
  var Marionette = {};
  __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Marionette = Marionette;

  // Get the DOM manipulator for later use
  Marionette.$ = __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].$;
  ...
  Marionette.extend = __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Model.extend;
  ...
  Marionette.triggerMethod = (function() {
    ...
    var triggerMethod = function(event) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(this.trigger)) {
        this.trigger.apply(this, arguments);
      }

      // call the onMethodName if it exists
      if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(method)) {
        // pass all arguments, except the event name
        return method.apply(this, __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].tail(arguments));
      }
    };
  ...
  Marionette.MonitorDOMRefresh = (function() {
    ...
    function triggerDOMRefresh(view) {
      if (view._isShown && view._isRendered) {
        if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(view.triggerMethod)) {
  ...
  (function(Marionette) {
    ...
    function bindFromStrings(target, entity, evt, methods) {
      ...
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(methodNames, function(methodName) {
    ...
    function iterateEvents(target, entity, bindings, functionCallback, stringCallback) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(bindings)) {
        bindings = bindings.call(target);
      }

      // iterate the bindings and bind them
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(bindings, function(methods, evt) {

        // allow for a function as the handler, 
        // or a list of event names as a string
        if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(methods)) {
  ...
  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(Marionette.Callbacks.prototype, {
    ...
    reset: function() {
      ...
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(callbacks, function(cb) {
  ...
  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(Marionette.Controller.prototype, __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Events, {
    close: function() {
      this.stopListening();
  ...
  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(Marionette.Region, {
    ...
    buildRegion: function(regionConfig, defaultRegionType) {
      ...
      if (regionConfig.parentEl) {
        ...
        region.getEl = function(selector) {
          ...
          if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(parentEl)) {
            parentEl = parentEl();
          }
  ...
  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(Marionette.Region.prototype, __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Events, {
    ...
    show: function(view) {
      ...
      var isViewClosed = view.isClosed || __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isUndefined(view.$el);
  ...
  Marionette.RegionManager = (function(Marionette) {
    ...
    var RegionManager = Marionette.Controller.extend({
      ...
      addRegions: function(regionDefinitions, defaults) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(regionDefinitions, function(definition, name) {
          ...
          if (definition.selector) {
            definition = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].defaults({}, definition, defaults);
          }
      ...
      addRegion: function(name, definition) {
        ...
        var isObject = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isObject(definition);
        var isString = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isString(definition);
        var hasSelector = !!definition.selector;

        if (isString || (isObject && hasSelector)) {
          region = Marionette.Region.buildRegion(definition, Marionette.Region);
        } else if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(definition)) {
          region = Marionette.Region.buildRegion(definition, Marionette.Region);
        } else {
          region = definition;
        }
      ...
      removeRegions: function() {
        __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(this._regions, function(region, name) {
          this._remove(name, region);
        }, this);
      },
      ...
      _setLength: function() {
        this.length = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].size(this._regions);
      }
    ...
    __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(methods, function(method) {
      RegionManager.prototype[method] = function() {
        var regions = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].values(this._regions);
        var args = [regions].concat(__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].toArray(arguments));
        return __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"][method].apply(__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"], args);
      };
    });
  ...
  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(Marionette.TemplateCache, {
    templateCaches: {},
  ...
  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(Marionette.TemplateCache.prototype, {
    ...
    compileTemplate: function(rawTemplate) {
      return __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].template(rawTemplate);
    }
  });
  ...
  Marionette.View = __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].View.extend({

    constructor: function(options) {
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].bindAll(this, "render");
      ...
      this.options = options || {};
      __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].View.prototype.constructor.apply(this, args);
    ...
    mixinTemplateHelpers: function(target) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(templateHelpers)) {
        templateHelpers = templateHelpers.call(this);
      }
      return __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(target, templateHelpers);
    },
    ...
    configureTriggers: function() {
      ...
      var triggers = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].result(this, "triggers");

      // Configure the triggers, prevent default
      // action and stop propagation of DOM events
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(triggers, function(value, key) {

        var hasOptions = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isObject(value);
    ...
    _delegateDOMEvents: function(events) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(events)) {
        events = events.call(this);
      }

      var combinedEvents = {};
      var triggers = this.configureTriggers();
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(combinedEvents, events, triggers);

      __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].View.prototype.delegateEvents.call(this, combinedEvents);
    },
    ...
    undelegateEvents: function() {
      var args = Array.prototype.slice.call(arguments);
      __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].View.prototype.undelegateEvents.apply(this, args);
    ...
    bindUIElements: function() {
      ...
      var bindings = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].result(this, "_uiBindings");

      // empty the ui so we don't have anything to start with
      this.ui = {};

      // bind each of the selectors
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].keys(bindings), function(key) {
    ...
    unbindUIElements: function() {
      ...
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(this.ui, function($el, name) {
        delete this.ui[name];
      }, this);
  ...
  Marionette.CollectionView = Marionette.View.extend({
    ...
    showEmptyView: function() {
      ...
      if (EmptyView && !this._showingEmptyView) {
        ...
        var model = new __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Model();
    ...
    addItemView: function(item, ItemView, index) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(itemViewOptions)) {
    ...
    buildItemView: function(item, ItemViewType, itemViewOptions) {
      var options = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend({
        model: item
      }, itemViewOptions);
    ...
    _initChildViewStorage: function() {
      this.children = new __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].ChildViewContainer();
    },
  ...
  Marionette.CompositeView = Marionette.CollectionView.extend({
    ...
    getItemViewContainer: function(containerView) {
      ...
      if (itemViewContainer) {
        ...
        var selector = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(itemViewContainer) ? itemViewContainer() : itemViewContainer;
  ...
  Marionette.Layout = Marionette.ItemView.extend({
    ...
    addRegions: function(regions) {
      this.regions = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend({}, this.regions, regions);
    ...
    _initializeRegions: function(options) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(this.regions)) {
  ...
  Marionette.AppRouter = __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Router.extend({

    constructor: function(options) {
      __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Router.prototype.constructor.apply(this, slice(arguments));
    ...
    processAppRoutes: function(controller, appRoutes) {
      ...
      var routeNames = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].keys(appRoutes).reverse(); // Backbone requires reverted order of routes

      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(routeNames, function(route) {
    ...
    _addAppRoute: function(controller, route, methodName) {
      ...
      this.route(route, methodName, __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].bind(method, controller));
    }
  });
  ...
  Marionette.Application = function(options) {
    ...
    this.vent = new __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Wreqr.EventAggregator();
    this.commands = new __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Wreqr.Commands();
    this.reqres = new __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Wreqr.RequestResponse();
    this.submodules = {};

    __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(this, options);

    this.triggerMethod = Marionette.triggerMethod;
  };

  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(Marionette.Application.prototype, __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Events, {
  ...
  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(Marionette.Module.prototype, __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"].Events, {
    ...
    start: function(options) {
      ...
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(this.submodules, function(mod) {
    ...
    _runModuleDefinition: function(definition, customArgs) {
      ...
      var args = __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].flatten([
        this,
        this.app,
        __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__["default"],
        Marionette,
        Marionette.$, __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"],
        customArgs
      ]);
  ...
  __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].extend(Marionette.Module, {
    ...
    create: function(app, moduleNames, moduleDefinition) {
      ...
      __WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].each(moduleNames, function(moduleName, i) {
    ...
    _addModuleDefinition: function(parentModule, module, def, args) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isFunction(def)) {
        // if a function is supplied for the module definition
        fn = def;
        startWithParent = true;

      } else if (__WEBPACK_IMPORTED_MODULE_1__beisen_lodash__["default"].isObject(def)) {
...
/* harmony default export */ __webpack_exports__["default"] = (Marionette);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__beisen_backbone__ = __webpack_require__("./node_modules/@beisen/backbone/index-es6.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__beisen_marionette__ = __webpack_require__("./node_modules/@beisen/marionette/index-es6.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__beisen_jquery__ = __webpack_require__("./node_modules/@beisen/jquery/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__beisen_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__beisen_jquery__);
	...
	Marionette.Region.prototype.show = function(view, options){
		...
		if (view !== this.currentView) {
			if(this.currentView) {
				var lastViewEl = __WEBPACK_IMPORTED_MODULE_3__beisen_jquery__(this.currentView.el).clone();
			}
			this.close();
	...
	var mutiEventsApi = function(obj,action, name, rest) {
		...
		if(multiEventSplitter.test(name)) {
			...
			var prefix = names[0];
			var suffix = __WEBPACK_IMPORTED_MODULE_2__beisen_lodash__["default"].rest(names).join(".");
	...
	var talentEvents = {
	    ...
	    off: function(name, callback, context, options) {
			...
			names = name ? [name] : __WEBPACK_IMPORTED_MODULE_2__beisen_lodash__["default"].keys(this._events);
			for (i = 0, l = names.length; i < l; i++) {
				name = names[i];
				if (events = this._events[name]) {
					this._events[name] = retain = [];
	    ...
	    trigger: function(name) {
			...
			var last =  __WEBPACK_IMPORTED_MODULE_2__beisen_lodash__["default"].last(args);
			...
			if(last && last._mutiEvents) {
				__WEBPACK_IMPORTED_MODULE_2__beisen_lodash__["default"].each(events, function(item){
	...
	Talent.app.on("initialize:before", function(options){
		...
		Talent.app.reqres.setHandler('history:getQueryObject', function( options ){
			...
			var def = new __WEBPACK_IMPORTED_MODULE_3__beisen_jquery__["Deferred"];
	...
	Talent.app.on("initialize:after", function(options){
		...
		function delegateLinkClick(){
			...
			var delayClick = __WEBPACK_IMPORTED_MODULE_2__beisen_lodash__["default"].debounce(function(href, options){
				/**
			...
			__WEBPACK_IMPORTED_MODULE_3__beisen_jquery__(document).on('click', 'a:not([data-bypass])', function(e){
				 ...
				 */
				var href = __WEBPACK_IMPORTED_MODULE_3__beisen_jquery__(e.currentTarget).attr('href');
				/**
				...
				if (href && href.indexOf('#') === 0) {
					...
					if(__WEBPACK_IMPORTED_MODULE_3__beisen_jquery__(e.currentTarget).attr('data-trigger') === "false"){
						triggerFlag = false;
					}
					delayClick(href, {
						trigger: triggerFlag,
...
/***/ "./node_modules/expose-loader/index.js?$!./node_modules/expose-loader/index.js?_!./node_modules/@beisen/jquery/index.js":
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["$"] = __webpack_require__("./node_modules/expose-loader/index.js?_!./node_modules/@beisen/jquery/index.js");
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("./node_modules/webpack/buildin/global.js")))

/***/ }),

/***/ "./node_modules/expose-loader/index.js?_!./node_modules/@beisen/jquery/index.js":
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["_"] = __webpack_require__("./node_modules/@beisen/jquery/index.js");
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("./node_modules/webpack/buildin/global.js")))
