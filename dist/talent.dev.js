...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + chunkId + ".dev.js";
...
/***/ "./node_modules/@beisen/talent-no-require/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var Talent = (function(global, Backbone, _){
		...
		/** @lends BaseRouter.'[prototype]' */
	{
		...
		loadPageView: function() {
			...
			__webpack_require__.e/* require */(0/* duplicate */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [!(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())]; (function(RootPageView) {
	
				new Promise(function(resolve) { resolve(); }).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [!(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())]; (function(PageView) {
	...
	Talent.BasePageView = Marionette.Layout.extend({
		...
		,getLayoutView: function(callback) {
			...
			__webpack_require__.e/* require */(0/* duplicate */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [!(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())]; (function(layoutView) {
